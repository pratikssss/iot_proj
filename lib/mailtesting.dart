...
String userName = 'pratikm467@gmail.com';
String password = 'Spidey@12345';
...
Future<void> discoverExample() async {
  var email = 'pratikm467@gmail.com';
...
Future<void> mailExample() async {
  final email = 'pratikm467@gmail.com';
...
Future<void> smtpExample() async {
  ...
  try {
    ...
    builder.from = [MailAddress('My name', 'mahaja_851942@student.nitw.ac.in')];
    builder.to = [MailAddress('Your name', 'pratikm467@gmail.com')];
